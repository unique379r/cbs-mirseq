...
#usage: perl SOLiD_preprocess_filter_v2.pl -f test_F3.csfasta -g test_F3_QV.qual -p 1 -q 20 -e 3 -d 9 -n on -v on -o Out_test
...
# For Fragment analysis the most you will output is 4 files csfasta (T_F3.csfasta (result_output) & U_F3.csfasta (other_reads)) 
