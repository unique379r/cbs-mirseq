...
my $JavaScriptTemplateFile      = "./Scripts/javascriptTEMPLATE.txt";	# Set the full path so that you do not have to execute this script within the installed directory.
